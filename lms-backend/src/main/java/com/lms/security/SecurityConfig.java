    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/courses/top-free").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/courses/top-new-paid").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/courses/top-paid-popular").permitAll()
                .requestMatchers("/api/admin/**", "/api/analytics/**").hasAuthority("ADMIN")
                .requestMatchers("/api/educator/**").hasAuthority("EDUCATOR")
                .requestMatchers("/api/student/**").hasAuthority("STUDENT")
                .requestMatchers("/api/certificates/**").hasAnyAuthority("ADMIN", "EDUCATOR", "STUDENT")
